...
- `scripts/sync-claude-commands.sh` installs cortex-owned slash commands (`/waveframe`, `/design-scaffold`, `/design-system-synthesize`, `/design-architecture`, `/design-structure`, `/design-product-ui-system`, `/design-system-update`, `/design-drift-audit`) into `~/.claude/commands/`.

...
- **humanizer** — rewrite AI-sounding prose so it reads like the writer without changing what it says: strips not-X-but-Y contrasts, one-line closers, forced triads, dash overuse, inflated claims, and bold labels. by Siqi Chen, MIT. the five most persistent tells also live in the always-on writing profile

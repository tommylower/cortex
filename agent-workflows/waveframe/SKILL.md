...
Use this as the studio router for design-system and project setup work. waveframe helps move from loose references, half-built work, or finished code into durable project docs, design-system files, and handoff structures.

## Core model

- **Design systems** live in `cortex/design-systems/<name>-design/` as opt-in skills, beside `nothing-design`.
...
- **Local process notes** stay in `.waveframe/` and should be gitignored by default.
...
- `content-map` — turn approved sitemaps, docs, or wireframes into local content maps, ASCII wireframes, and section briefs.
- `design-structure` — apply one of your reusable output templates, such as a design-system deck, brand overview deck, product UI system board, landing-page variant, or other prebuilt structure, to a selected design system and target surface.
...
```text
- Source influence: cortex/design-skills/responsive-craft
...
- `references/content-map.md` — use for turning approved sitemaps, docs, or existing wireframes into local content maps, ASCII wireframes, and promotable section briefs.
- `references/structure.md` — use for applying reusable output templates to a selected design system and target surface.

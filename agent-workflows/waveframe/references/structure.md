...
Use this mode to apply one of your reusable output templates to a selected design system and target surface.
...
The structure library is reusable Cortex scaffolding for decks, landing pages, dashboards, component libraries, and other repeatable deliverables. Do not copy structure templates into project repos unless the user explicitly asks.

...
Any visible placeholder that includes `[client]`, `[Client]`, `client`, or an old source-project name must be replaced with the selected client/project name in sentence case.
...
| --- | --- | --- | --- | --- | --- |
| 01 | `<client>-intro` | `Slide 01 - Client design system` | `224:82` | `<Client> design system` | `Title slide. Cover treatment for the design system deck - placeholder for the hero / wordmark.` |
...
- Replace old source-client references with the selected client/project name.

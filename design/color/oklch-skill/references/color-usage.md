...
The increased-contrast variant must create visibly stronger differentiation.
There is no universal OKLCH L increment that guarantees this across hues,
chroma values, and translucent backdrops. Measure the rendered pair with APCA
as a design diagnostic and WCAG 2 for conformance.

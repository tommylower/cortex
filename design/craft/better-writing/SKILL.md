---
name: better-writing
description: UX writing for product interfaces. Use when writing or reviewing voice, terminology, labels, links, errors, placeholders, settings, onboarding, notifications, or empty states.
...
Use this format only when the user asks for a standalone writing review. When

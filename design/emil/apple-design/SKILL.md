...
> Vendored from [emilkowalski/skills](https://github.com/emilkowalski/skills/tree/main/skills/apple-design) at `d16ebe6` (MIT). In Cortex, the active project's tokens and Studio's rules win; values here are examples for when the project has no answer.

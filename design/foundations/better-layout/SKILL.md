---
name: better-layout
description: Layout structure for web interfaces. Use when building or reviewing grouping, alignment, spacing, reading order, progressive disclosure, responsive adaptation, safe areas, or RTL layout.
...
Use this format only when the user asks for a standalone layout review. When

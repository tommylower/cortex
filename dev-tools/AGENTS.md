...
overlays, annotation tools, tuning tools, and local dev helpers that get installed into a project.
...
- **interface-kit** — install the Interface Kit visual design overlay in a Next.js project. by Josh Puckett
